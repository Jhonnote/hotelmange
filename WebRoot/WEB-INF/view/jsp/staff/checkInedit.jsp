...
<div class="well">
        <label>key</label>
        <input type="text" name="key" value="${permissions.key}" class="input-xlarge">
        <label>权限名称</label>
        <input type="text" name="name" value="${permissions.name}" class="input-xlarge">
        <label>url地址</label>
        <input type="text" name="url" value="${permissions.url}" class="input-xlarge">
        <label>状态</label>
