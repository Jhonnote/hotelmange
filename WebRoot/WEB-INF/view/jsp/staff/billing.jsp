  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <c:if test="${item.id==itemchil.par_id }">
            <li <c:if test="${itemchil.name=='结账'}">class='active'</c:if>>
    ...
    <div class="content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="users.html">客户入住管理</a> <span class="divider">/</span></li>
...
<div class="row-fluid">
<div class="well">
<!--     <div><a href="<c:url value='/checkinadd'/>">添加客户入住</a></div> -->
    <table class="table">
      <thead>
        <tr>
          <th>客户名</th>
      ...
      <tbody>
      <c:forEach items="${checkin}" var="item">
       <tr>
          <td>${item.name}</td>
          <td>${item.room_id}</td>
          <td>${item.price}</td>
          ...
          <td>${item.status}<td>
          <td>
<!--                <a href="<c:url value='/checkinbilling/${item.id}'/>">结帐</a> -->
<!--                <a href="<c:url value='/reserveedit/${item.id}'/>">修改</a> -->
