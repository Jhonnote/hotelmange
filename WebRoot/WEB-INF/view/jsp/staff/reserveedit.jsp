  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <c:if test="${item.id==itemchil.par_id }">
            <li <c:if test="${itemchil.name=='权限管理'}">class='active'</c:if>>
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
<form action="<c:url value='/permissionedit'/>" method="post">  
${msg}       
...
<div class="well">
        <label>客户名字</label>
        <input type="text" name="name" value="${checkin.name}" class="input-xlarge">
        <label>手机号</label>
        <input type="text" name="phonenum" value="${checkin.phonenum}" class="input-xlarge">
        <label>身份证号</label>
        <input type="text" name="idcar" value="${checkin.idcar}" class="input-xlarge">
        <label>房间类型</label>
        ...
        <option value="${room.id}">房号${room.id} 价格￥${room.price} 人数${room.number}</option>
        </select>
</div>
