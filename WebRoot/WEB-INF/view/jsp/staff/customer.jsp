23456<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <c:if test="${item.id==itemchil.par_id }">
            <li <c:if test="${itemchil.name=='客户管理'}">class='active'</c:if>>
...
<div class="row-fluid">
<div class="well">
    <div><a href="<c:url value='/reserveadd'/>">添加客户</a></div>
    <table class="table">
      <thead>
        <tr>
          <th>客户名称</th>
