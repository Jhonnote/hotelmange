    ...
    <table class="table">
      ...
      <c:forEach items="${rolelist}" var="item">
       <tr>
          ...
          <td>
          <c:choose>
          <c:when test="${item.status=='0'}">可用</c:when>
          <c:otherwise>禁用</c:otherwise>
          </c:choose>
          </td>
          <td>
              <a href="<c:url value='/roleedit/${item.id}'/>"><i class="icon-pencil"></i></a>
              <a href="<c:url value='/role/bind/${item.id}'/>"><i class="icon-plus"></i></a>
