...
<div class="row-fluid">
<div class="well">
    <div><a href="<c:url value='/permission/add'/>">添加权限</a></div>
    <table class="table">
      <thead>
        <tr>
          <th>key</th>
      ...
      <tbody>
      <c:forEach items="${permissionli}" var="item">
       <tr>
          <td>${item.key}</td>
          <td>${item.name}</td>
          <td>${item.url}</td>
          ...
          <td>
              <a href="<c:url value='/permissionedit/${item.id}'/>"><i class="icon-pencil"></i></a>
