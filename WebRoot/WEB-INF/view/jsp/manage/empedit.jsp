...
<html lang="en">
  <head>
    ...
    <!-- 引用时间选择器 -->
    <script src="<c:url value='/lib/My97DatePicker/WdatePicker.js'/>" type="text/javascript" ></script>
  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
<form action="<c:url value='/empEdit'/>" method="post">  
${msg}       
...
<div class="well">
        <label>账户</label>
        <input type="text" name="account" value="${management.account }" class="input-xlarge">
        <label>密码</label>
        <input type="text" name="password" value="${management.password }" class="input-xlarge">
        <label>职位</label>
        <input type="text" name="name" value="${management.name }" class="input-xlarge">
<%--        <label>创建时间</label>--%>
<%--        <input type="text" name="date" value="${management.date }" class="input-xlarge" onclick="WdatePicker()">--%>
        <label>状态</label>
        <input type="text" name="status" value="${management.status }" class="input-xlarge">
        <label>角色id</label>
        <input type="text" name="role_id" value="1" class="input-xlarge" readonly="readonly">
</div>
