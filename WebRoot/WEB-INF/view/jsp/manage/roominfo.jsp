...
<div class="row-fluid">
<div class="well">
    <div><a href="<c:url value='/roomAdd'/>">添加</a></div> 
	    ...
	    <table class="table">
	      ...
	      <c:forEach items="${lists}" var="item">
	       <tr>
	          ...
	          <td>${item.number}</td>
	          <td>${item.status}</td>
	          <td><a href="<c:url value='roomEdit?id=${item.id}'/>">修改</a>|
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>是否确定删除这条！</p>
    </div>
    ...
    <script type="text/javascript">
        ...
        function comitdelete(obj){
           ...
           window.location.href="/hotelmessage/roomDelete?id="+dataid;
        }
    </script>
  </body>
</html>
