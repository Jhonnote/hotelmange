  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <c:if test="${item.id==itemchil.par_id }">
            <li <c:if test="${itemchil.name=='客房类型'}">class='active'</c:if>>
    ...
    <div class="content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="users.html">客房管理</a> <span class="divider">/</span></li>
            <li class="active">客房类型</li>
        </ul>
        <div class="container-fluid">
            <div class="row-fluid">
<div class="row-fluid">
<div class="well">
    <div><a href="<c:url value='/roomTypeAdd'/>">添加</a></div> 
    <form name="roomForm" action="<c:url value='/kefangType'/>" method="post">
	    <table class="table">
	      <thead>
	        <tr>
	          <th>客房类型</th>
	      ...
	      <c:forEach items="${list}" var="item">
	       <tr>
	          <td>${item.type}</td>
	          <td><a href="#" onclick="deletes('${item.id}')">删除</a></td>
	        </tr>
	      </c:forEach>
	      </tbody>
	    </table>
...
<div class="pagination">
    ...
    <script type="text/javascript">
        ...
        function comitdelete(obj){
           ...
           window.location.href="/hotelmessage/roomTypeDelete?id="+dataid;
        }
    </script>
  </body>
</html>
